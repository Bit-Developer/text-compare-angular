...
Read tutorial [Deploying Angular Application to Netlify](https://jojozhuang.github.io/tutorial/angular/deploying-angular-application-to-netlify/) to learn how this angular app is deployed to Netlify.
